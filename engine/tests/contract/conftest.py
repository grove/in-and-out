"""
Contract tests validate that the PostgreSQL schema contract between ingestion,
OSI-Mapping, and writeback is maintained across migrations.
These require Docker (testcontainers) but are separate from integration tests.
